...
let user_answer = await inquirer.prompt([
  ...
  },
  {
    ...
    message: chalk.blueBright(
      "Please select the currency you want to convert t0: "
    ),
    type: "list",
    choices: [
      "USD",
...
console.log(
  `${chalk.yellowBright(user_answer.amount)} ${chalk.yellowBright(
    user_answer.from
  )} in ${chalk.redBright(user_answer.to)} is: ${chalk.cyanBright(
